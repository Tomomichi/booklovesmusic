...
App::import('Vendor', 'Zend/Validate/Abstract');

/**
 * @see Zend_Validate_Ip
 */
//require_once 'Zend/Validate/Ip.php';
App::import('Vendor', 'Zend/Validate/Ip');
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        'AC'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾄ・ζ・・夏尭再焼惰篤瞭卞崙敍｡ﾄ｣ﾄ･ﾄｧﾄｫﾄｯﾄｵﾄｷﾄｺﾄｼﾄｾﾅﾅで・・闇暁打毒頁稜卩崘敘淒｡ﾅ｣ﾅ･ﾅｧﾅｫﾅｭﾅｯﾅｱﾅｳﾅｵﾅｷﾅｺﾅｼﾅｾ]{1,63}$/iu'),
        'AR'  => array(1 => '/^[\x{002d}0-9a-za-ac-eiin-ou]{1,63}$/iu'),
        'AS'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾄ・ζ・・夏尭再焼惰篤米瞭卞崙敍淨｡ﾄ｣ﾄ･ﾄｧﾄｩﾄｫﾄｭﾄｯﾄｱﾄｵﾄｷﾄｸﾄｺﾄｼﾄｾﾅで・・闇暁最焦打毒頁稜卩崘敘淒｡ﾅ｣ﾅ･ﾅｧﾅｩﾅｫﾅｭﾅｯﾅｱﾅｳﾅｵﾅｷﾅｺﾅｼ]{1,63}$/iu'),
        'AT'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾅ毒｡ﾅｾ]{1,63}$/iu'),
        'BIZ' => 'Hostname/Biz.php',
        'BR'  => array(1 => '/^[\x{002d}0-9a-za-aceio-ouu]{1,63}$/iu'),
        'BV'  => array(1 => '/^[\x{002d}0-9a-zaaa-een-ooouﾄ再打・暁｡ﾅｧﾅｾ]{1,63}$/iu'),
        'CAT' => array(1 => '/^[\x{002d}0-9a-z・ac-eiioouu]{1,63}$/iu'),
        'CH'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾅ転{1,63}$/iu'),
        'CL'  => array(1 => '/^[\x{002d}0-9a-zaeinouu]{1,63}$/iu'),
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'Zend/Validate/Hostname/Com.php',
        'DE'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾄζ・・・夏再尭焼惰米崙瞭卞篤淨敍｡ﾄ｣ﾄ･ﾄｧﾄｭﾄｩﾄｯﾄｫﾄｱﾄｵﾄｷﾄｺﾄｾﾄｼﾅで・闇・暁焦打最篤ｸﾅ頁卩稜崘敘｡ﾅ淒･ﾅ｣ﾅｧﾅｭﾅｯﾅｱﾅｩﾅｳﾅｫﾅｵﾅｷﾅｺﾅｾﾅｼ]{1,63}$/iu'),
        'DK'  => array(1 => '/^[\x{002d}0-9a-zaeou]{1,63}$/iu'),
        'ES'  => array(1 => '/^[\x{002d}0-9a-zaaceeiinoouu・]{1,63}$/iu'),
        'EU'  => array(1 => '/^[\x{002d}0-9a-za-oo-y]{1,63}$/iu',
            2 => '/^[\x{002d}0-9a-zﾄ・ζ・・夏尭再焼惰篤米瞭卞崙敍淨｡ﾄ｣ﾄ･ﾄｧﾄｩﾄｫﾄｭﾄｯﾄｱﾄｵﾄｷﾄｺﾄｼﾄｾﾅﾅで・・闇嫁暁最焦打毒頁稜卩崘敘｡ﾅ･ﾅｧﾅｩﾅｫﾅｭﾅｯﾅｱﾅｳﾅｵﾅｷﾅｺﾅｼﾅｾ]{1,63}$/iu',
            3 => '/^[\x{002d}0-9a-zﾈ卻嫋{1,63}$/iu',
            4 => '/^[\x{002d}0-9a-zﾎ石ｬﾎｭﾎｮﾎｯﾎｰαβγδεζηθικλμνξοπρﾏｃﾐτυφχψωﾏ観均狐済讃{1,63}$/iu',
            5 => '/^[\x{002d}0-9a-zабвгдежзийклмнопрстуфхцчшщъыьэюя]{1,63}$/iu',
            6 => '/^[\x{002d}0-9a-z眈-眈・ｼ退-眈甫ｼ黴-眈ｧ眈ｰ-眈ｷ眇-眇・ｽ退-眇例ｽ黴-眇ｧ眇ｰ-ﾏ若ｾ-眄・ｾ退-眄例ｾ黴-眄ｧ眄ｰ-眄ｴ眄ｶ眄ｷ眩ゃｿ・ｿ・ｿ・ｿ・ｿ退-ﾎ雪ｿ貰ｿ例ｿ黴-眩ｧ眩ｲ眩ｳ眩ｴ眩ｶ眩ｷ]{1,63}$/iu'),
        'FI'  => array(1 => '/^[\x{002d}0-9a-zaao]{1,63}$/iu'),
        'GR'  => array(1 => '/^[\x{002d}0-9a-zﾎ・夷火莞湖雕-ΡΣ-ﾏ若ｼ-眈甫ｼ鬆-眈昵ｼ黴-眇・ｽ陟-眇冴ｽ退-眇例ｽ吼ｽ帋ｽ昵ｽ鮠-眇ｽ眄-眄ｴ眄ｶ-眄ｼ眩ゃｿ・ｿ・ｿ陂-眩吾ｿ退-眩乍ｿ髦-眩帋ｿ黴-眩ｬ眩ｲ眩ｳ眩ｴ眩ｶ-眩ｼ]{1,63}$/iu'),
        'HK'  => 'Zend/Validate/Hostname/Cn.php',
        'HU'  => array(1 => '/^[\x{002d}0-9a-zaeioouuﾅ打ｱ]{1,63}$/iu'),
        'INFO'=> array(1 => '/^[\x{002d}0-9a-zaaaeoou]{1,63}$/iu',
            2 => '/^[\x{002d}0-9a-zaeioouuﾅ打ｱ]{1,63}$/iu',
            3 => '/^[\x{002d}0-9a-zaaeidoouyt]{1,63}$/iu',
            4 => '/^[\x{AC00}-\x{D7A3}]{1,17}$/iu',
            5 => '/^[\x{002d}0-9a-zﾄ・再篤｣ﾄｫﾄｷﾄｼﾅ・最稜｡ﾅｫﾅｾ]{1,63}$/iu',
            6 => '/^[\x{002d}0-9a-zﾄ・再瞭卞ｯﾅ｡ﾅｫﾅｳﾅｾ]{1,63}$/iu',
            7 => '/^[\x{002d}0-9a-zoﾄ・・卩で・崘ｺﾅｼ]{1,63}$/iu',
            8 => '/^[\x{002d}0-9a-zaeinouu]{1,63}$/iu'),
        'IO'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾄζ・・・夏再尭焼惰米崙瞭卞篤淨敍｡ﾄ｣ﾄ･ﾄｧﾄｭﾄｩﾄｯﾄｫﾄｱﾄｵﾄｷﾄｺﾄｾﾄｼﾅで・闇・暁焦打最篤ｸﾅ頁卩稜崘敘｡ﾅ淒･ﾅ｣ﾅｧﾅｭﾅｯﾅｱﾅｩﾅｳﾅｫﾅｵﾅｷﾅｺﾅｾﾅｼ]{1,63}$/iu'),
        'IS'  => array(1 => '/^[\x{002d}0-9a-zaeyuiotaod]{1,63}$/iu'),
        'JP'  => 'Zend/Validate/Hostname/Jp.php',
        'KR'  => array(1 => '/^[\x{AC00}-\x{D7A3}]{1,17}$/iu'),
        'LI'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾅ転{1,63}$/iu'),
        'LT'  => array(1 => '/^[\x{002d}0-9ﾄ・再卞瞭ｯﾅ｡ﾅｳﾅｫﾅｾ]{1,63}$/iu'),
        'MD'  => array(1 => '/^[\x{002d}0-9ﾄヂiﾅ淒｣]{1,63}$/iu'),
        'MUSEUM' => array(1 => '/^[\x{002d}0-9a-za-oo-yﾄ・ζ・・尭再焼惰篤瞭卞崙淨｡ﾄ｣ﾄｧﾄｫﾄｯﾄｱﾄｷﾄｺﾄｼﾄｾﾅで・・闇暁最打毒頁稜卩崘淒｡ﾅ｣ﾅ･ﾅｧﾅｫﾅｯﾅｱﾅｳﾅｵﾅｷﾅｺﾅｼﾅｾﾇ蕊隻追能x{01E5}\x{01E7}\x{01E9}\x{01EF}ﾉ兔x{0292}蘯≪ｺ・ｺ・ｻｳ]{1,63}$/iu'),
        'NET' => 'Zend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zaaa-een-ooouﾄ再打・暁｡ﾅｧﾅｾ]{1,63}$/iu'),
        'NU'  => 'Zend/Validate/Hostname/Com.php',
        'ORG' => array(1 => '/^[\x{002d}0-9a-zaeinouu]{1,63}$/iu',
            2 => '/^[\x{002d}0-9a-zoﾄ・・卩で・崘ｺﾅｼ]{1,63}$/iu',
            3 => '/^[\x{002d}0-9a-zaaaaeeidooouuyt]{1,63}$/iu',
            4 => '/^[\x{002d}0-9a-zaeioouuﾅ打ｱ]{1,63}$/iu',
            5 => '/^[\x{002d}0-9a-zﾄ・再瞭卞ｯﾅ｡ﾅｫﾅｳﾅｾ]{1,63}$/iu',
            6 => '/^[\x{AC00}-\x{D7A3}]{1,17}$/iu',
            7 => '/^[\x{002d}0-9a-zﾄ・再篤｣ﾄｫﾄｷﾄｼﾅ・最稜｡ﾅｫﾅｾ]{1,63}$/iu'),
        'PE'  => array(1 => '/^[\x{002d}0-9a-znaeiouu]{1,63}$/iu'),
        'PL'  => array(1 => '/^[\x{002d}0-9a-zﾄ・再篤｣ﾄｫﾄｷﾄｼﾅ・最稜｡ﾅｫﾅｾ]{1,63}$/iu',
            2 => '/^[\x{002d}а-ик-ш\x{0450}ﾑ酉篇佯厶墫慯歉{1,63}$/iu',
            3 => '/^[\x{002d}0-9a-zaiﾄη淒｣]{1,63}$/iu',
            4 => '/^[\x{002d}0-9а-яё\x{04C2}]{1,63}$/iu',
            5 => '/^[\x{002d}0-9a-zaaaeeeiiiooouuuﾄ尭｡ﾄｧﾅｼ]{1,63}$/iu',
            6 => '/^[\x{002d}0-9a-zaaaaeeooooou]{1,63}$/iu',
            7 => '/^[\x{002d}0-9a-zoﾄ・・卩で・崘ｺﾅｼ]{1,63}$/iu',
            8 => '/^[\x{002d}0-9a-zaaaaceeioooouu]{1,63}$/iu',
            9 => '/^[\x{002d}0-9a-zaiﾄη淒｣]{1,63}$/iu',
            10=> '/^[\x{002d}0-9a-zaaeioouyﾄ再焼ｺﾄｾﾅ闇頁｡ﾅ･ﾅｾ]{1,63}$/iu',
            11=> '/^[\x{002d}0-9a-zce]{1,63}$/iu',
            12=> '/^[\x{002d}0-9а-ик-шﾑ柘佯厶墫嶝歉{1,63}$/iu',
            13=> '/^[\x{002d}0-9a-zﾄ・再打｡ﾅｾ]{1,63}$/iu',
            14=> '/^[\x{002d}0-9a-zacouuﾄ淨ｱﾅ歉{1,63}$/iu',
            15=> '/^[\x{002d}0-9a-zaeinouu]{1,63}$/iu',
            16=> '/^[\x{002d}0-9a-zaoouﾅ｡ﾅｾ]{1,63}$/iu',
            17=> '/^[\x{002d}0-9a-zﾄ夏敍･ﾄｵﾅ敘ｭ]{1,63}$/iu',
            18=> '/^[\x{002d}0-9a-zaaeeio]{1,63}$/iu',
            19=> '/^[\x{002d}0-9a-zaaaaaaceeeeiiiidnoooouuuuyﾄ・最で・卩崘｡]{1,63}$/iu',
            20=> '/^[\x{002d}0-9a-zaaaooouﾅ｡ﾅｾ]{1,63}$/iu',
            21=> '/^[\x{002d}0-9a-zaaceeiioouu]{1,63}$/iu',
            22=> '/^[\x{002d}0-9a-zaaeioouuﾅ打ｱ]{1,63}$/iu',
            23=> '/^[\x{002d}0-9ﾎ石ｬ-ﾏ讃{1,63}$/iu',
            24=> '/^[\x{002d}0-9a-zaaaaaceeeedooooutﾅ転{1,63}$/iu',
            25=> '/^[\x{002d}0-9a-zaaeioouuyﾄ再焼崘闇卩｡ﾅ･ﾅｯﾅｾ]{1,63}$/iu',
            26=> '/^[\x{002d}0-9a-z・aceeiioouu]{1,63}$/iu',
            27=> '/^[\x{002d}0-9а-ъьюя\x{0450}\x{045D}]{1,63}$/iu',
            28=> '/^[\x{002d}0-9а-яёﾑ毛枉{1,63}$/iu',
            29=> '/^[\x{002d}0-9a-zﾄ・再瞭卞ｯﾅ｡ﾅｫﾅｳﾅｾ]{1,63}$/iu',
            30=> '/^[\x{002d}0-9a-zaaaaeeidooouuyt]{1,63}$/iu',
            31=> '/^[\x{002d}0-9a-zaaaceeeeiinouuuyﾅ転{1,63}$/iu',
            32=> '/^[\x{002d}0-9а-щъыьэюяёﾑ飯毛淋曽{1,63}$/iu',
            33=> '/^[\x{002d}0-9ﾗ退-ﾗｪ]{1,63}$/iu'),
        'PR'  => array(1 => '/^[\x{002d}0-9a-zaeiounaeiuoaeiouaeuacﾅ殿o]{1,63}$/iu'),
        'PT'  => array(1 => '/^[\x{002d}0-9a-zaaaaceeiooou]{1,63}$/iu'),
        'RU'  => array(1 => '/^[\x{002d}0-9а-яё]{1,63}$/iu'),
        'SA'  => array(1 => '/^[\x{002d}.0-9\x{0621}-\x{063A}\x{0641}-\x{064A}\x{0660}-\x{0669}]{1,63}$/iu'),
        'SE'  => array(1 => '/^[\x{002d}0-9a-zaaeou]{1,63}$/iu'),
        'SH'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾄζ・・・夏再尭焼惰米崙瞭卞篤淨敍｡ﾄ｣ﾄ･ﾄｧﾄｭﾄｩﾄｯﾄｫﾄｱﾄｵﾄｷﾄｺﾄｾﾄｼﾅで・闇・暁焦打最篤ｸﾅ頁卩稜崘敘｡ﾅ淒･ﾅ｣ﾅｧﾅｭﾅｯﾅｱﾅｩﾅｳﾅｫﾅｵﾅｷﾅｺﾅｾﾅｼ]{1,63}$/iu'),
        'SJ'  => array(1 => '/^[\x{002d}0-9a-zaaa-een-ooouﾄ再打・暁｡ﾅｧﾅｾ]{1,63}$/iu'),
        'TH'  => array(1 => '/^[\x{002d}0-9a-z\x{0E01}-\x{0E3A}\x{0E40}-\x{0E4D}\x{0E50}-\x{0E59}]{1,63}$/iu'),
        'TM'  => array(1 => '/^[\x{002d}0-9a-za-oo-yﾄ・ζ・・夏尭再焼惰篤瞭卞崙敍｡ﾄ｣ﾄ･ﾄｧﾄｫﾄｯﾄｵﾄｷﾄｺﾄｼﾄｾﾅﾅで・・闇暁打毒頁稜卩崘敘淒｡ﾅ｣ﾅ･ﾅｧﾅｫﾅｭﾅｯﾅｱﾅｳﾅｵﾅｷﾅｺﾅｼﾅｾ]{1,63}$/iu'),
        'TW'  => 'Zend/Validate/Hostname/Cn.php',
        'TR'  => array(1 => '/^[\x{002d}0-9a-zﾄ淨ｱuﾅ殪c]{1,63}$/iu'),
        'VE'  => array(1 => '/^[\x{002d}0-9a-zaeiouun]{1,63}$/iu'),
        'VN'  => array(1 => '/^[AAAAEEEIIOOOOUUYaaaaeeeiioooouuyﾄてζ斉惰ｨﾄｩﾅｨﾅｩﾆ黴ﾆ｡ﾆｯﾆｰ\x{1EA0}-\x{1EF9}]{1,63}$/iu'),
        'ﾘｧﾛ鈷ｱﾘｧﾙ陂' => array(1 => '/^[\x{0621}-\x{0624}\x{0626}-\x{063A}\x{0641}\x{0642}\x{0644}-\x{0648}\x{067E}\x{0686}\x{0698}\x{06A9}\x{06AF}\x{06CC}\x{06F0}-\x{06F9}]{1,30}$/iu'),
        '中国' => 'Zend/Validate/Hostname/Cn.php',
        '公司' => 'Zend/Validate/Hostname/Cn.php',
        '网扈鰀' => 'Zend/Validate/Hostname/Cn.php'
    );
        ...
        if ((count($domainParts) > 1) && (strlen($value) >= 4) && (strlen($value) <= 254)) {
            ...
            do {
                ...
                if (preg_match('/([^.]{2,10})$/i', end($domainParts), $matches) ||
                    (end($domainParts) == 'ﾘｧﾛ鈷ｱﾘｧﾙ陂') || (end($domainParts) == '中国') ||
                    (end($domainParts) == '公司') || (end($domainParts) == '网扈鰀')) {
                    ...
                    if ($this->_options['idn'] &&  isset($this->_validIdns[strtoupper($this->_tld)])) {
                        if (is_string($this->_validIdns[strtoupper($this->_tld)])) {
                        	App::import('Vendor', 'Zend/Validate/Hostname/Com_2');
//                        	$regexChars = $com_array;
