...
App::import('Vendor', 'Zend/Gdata/App/Feed');

/**
 * Zend_Gdata_Http_Client
 */
//require_once 'Zend/Http/Client.php';
App::import('Vendor', 'Zend/Http/Client');
...
App::import('Vendor', 'Zend/Gdata/App/MediaSource');
...
class Zend_Gdata_App
{
        ...
        $body = null, $contentType = null, $remainingRedirects = null)
    {
		...
		App::import('Vendor', 'Zend/Http/Client/Exception');
        ...
        if ($url === null) {
            //require_once 'Zend/Gdata/App/InvalidArgumentException.php';
			App::import('Vendor', 'Zend/Gdata/App/InvalidArgumentException');
            throw new Zend_Gdata_App_InvalidArgumentException(
		...
		App::import('Vendor', 'Zend/Uri/Http');
...
//                require_once 'Zend/Gdata/HttpAdapterStreamingProxy.php';
                App::import('Vendor','Zend/Gdata/HttpAdapterStreamingProxy');
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
//                require_once 'Zend/Gdata/HttpAdapterStreamingSocket.php';
                App::import('Vendor','Zend/Gdata/HttpAdapterStreamingSocket');
        ...
        if (!$response->isSuccessful()) {
            //require_once 'Zend/Gdata/App/HttpException.php';
            App::import('Vendor','Zend/Gdata/App/HttpException');
