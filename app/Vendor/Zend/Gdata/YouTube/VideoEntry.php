...
class Zend_Gdata_YouTube_VideoEntry extends Zend_Gdata_YouTube_MediaEntry
{
    ...
    /**
     * Get the VideoEntrys Zend_Gdata_YouTube_Extension_MediaGroup object.
    ...
    /**
     * Helper function to conveniently set a videos rating.
     *
    ...
    /**
     * Retrieve the URL for a videos comment feed.
     *
