...
App::import('Vendor', 'Zend/Http/Client/Adapter/Interface');
...
App::import('Vendor', 'Zend/Http/Response');

/**
 * @see Zend_Http_Response_Stream
 */
//require_once 'Zend/Http/Response/Stream.php';
App::import('Vendor', 'Zend/Http/Response/Stream');
...
//            require_once 'Zend/Http/Client/Exception.php';
    ...
    public function setConfig($config = array())
    {
        if ($config instanceof Zend_Config) {
            ...
            /** @see Zend_Http_Client_Exception */
//            require_once 'Zend/Http/Client/Exception.php';
			App::import('Controller', 'Zend/Http/Client/Exception');
