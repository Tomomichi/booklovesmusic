...
class Zend_Gdata_YouTube extends Zend_Gdata_Media
{
    ...
    /**
     * The suffix for the users upload feed.
     *
     * @var string
     */
    ...
    /**
     * Retrieves a video entry from the users upload feed.
     *
     * @param mixed $videoID The ID of the video to retrieve.
     * @throws Zend_Gdata_App_HttpException
    ...
    /**
     * Retrieves a feed which lists a users playlist
     *
	...
	//2012.5.13Ž©ì
    public function getPlaylistListEntry($listId = null)
    {
        $uri = self::PLAYLIST_URI . "/" . $listId."?v=2";
        return parent::getEntry($uri, 'Zend_Gdata_YouTube_PlaylistListEntry');
    }
    ...
    /**
     * Retrieves a feed of a users subscriptions
     *
     * @param string $user (optional) The username of interest
     * @param mixed $location (optional) The URL to query or a
     *         Zend_Gdata_Query object from which a URL can be determined
    ...
    /**
     * Retrieves a feed of a users contacts
     *
     * @param string $user (optional) The username of interest
     * @param mixed $location (optional) The URL to query or a
     *         Zend_Gdata_Query object from which a URL can be determined
    ...
    /**
     * Retrieves a users profile as an entry
     *
     * @param string $user (optional) The username of interest
     * @param mixed $location (optional) The URL to query or a
     *         Zend_Gdata_Query object from which a URL can be determined
    ...
    /**
     * Retrieve a feed of messages in the currently authenticated users inbox.
     *
     * @throws Zend_Gdata_App_Exception if not logged in.
